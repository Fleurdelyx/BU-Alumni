...
export function AppearanceForm() {
  ...
  return (
    <Card className="border-mist/60 dark:border-sidebar-border/50">
      <CardHeader>
        <CardTitle className="text-forest dark:text-sidebar-foreground">Appearance</CardTitle>
        <CardDescription>Customize the look and feel of the admin portal.</CardDescription>
      </CardHeader>
      <CardContent>
