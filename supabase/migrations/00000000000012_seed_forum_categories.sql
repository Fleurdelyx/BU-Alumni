-- Seed forum categories (required for forum to function)
...
-- Seed a default active questionnaire
INSERT INTO public.questionnaires (title, description, is_active, batch_year, deadline)
VALUES (
  'BU Graduate Tracer Study 2025-2026',
  'Official CHED-aligned graduate tracer study for academic year 2025-2026',
  TRUE,
  2025,
  '2026-06-30'
)
